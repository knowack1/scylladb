...
public:
    ...
    named_value<uint32_t> vector_store_keepalive_idle_in_s;
    named_value<uint32_t> vector_store_keepalive_interval_in_s;
    named_value<uint32_t> vector_store_keepalive_count;
