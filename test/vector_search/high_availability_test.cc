#include "service/vector_search/high_availability.hh"
#include <seastar/testing/test_case.hh>

using namespace service::vector_search;

SEASTAR_TEST_CASE(allows_to_register_listener) {
    high_availability ha{[](auto const&) { return seastar::make_ready_future<std::unordered_set<seastar::net::inet_address>>(); }};
